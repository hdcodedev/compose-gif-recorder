...
private const val GENERATED_PACKAGE = "io.github.dautovicharis.composegif.generated"
...
private class RecordGifSymbolProcessor(
    ...
    private fun generateRegistry(entries: List<ScenarioEntry>) {
        val scenarioSpec = ClassName("io.github.dautovicharis.composegif.core", "GifScenarioSpec")
        val captureConfig = ClassName("io.github.dautovicharis.composegif.core", "GifCaptureConfig")
        val coreTheme = ClassName("io.github.dautovicharis.composegif.core", "GifTheme")
        val scenarioRegistry = ClassName("io.github.dautovicharis.composegif.core", "GifScenarioRegistry")
        val validator = ClassName("io.github.dautovicharis.composegif.core", "GifCaptureValidator")
